                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Typography variant="body2">
                            More details on <Link href={explorerAddressForBlock} target="_blank" rel="noreferrer" sx={{textDecoration: 'underline', color: 'text.primary', fontWeight: 'bold'}}>Karlsen&nbsp;Block&nbsp;Explorer</Link>
                        </Typography>
                    </Box>
                </Box>
            </Paper>
